...
import { Plus, Trash2, Edit, MessageSquare, Mail, Loader2, Copy, FileText } from 'lucide-react';
...
export default function TemplatesPage() {
  ...
  const saveEmailTemplate = async () => {
    ...
    try {
      ...
      const body = editingEmailTemplate
        ? { id: editingEmailTemplate.id, ...emailForm }
        : emailForm;
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-500">Manage your SMS and Email templates</p>
              </div>
            </div>
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                      ...
                      <CardDescription>Create and manage SMS message templates with variables</CardDescription>
                    </div>
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                      ...
                      <CardDescription>Create and manage email templates with subject lines</CardDescription>
                    </div>
                          ...
                          <div key={template.id} className="border rounded-lg p-4 hover:bg-gray-50">
                            <div className="flex justify-between items-start">
                              <div className="flex-1">
                                ...
                                <p className="text-sm font-medium text-gray-700 mt-1">Subject: {template.subject}</p>
                                <p className="text-sm text-gray-600 mt-1 line-clamp-2">{template.content.replace(/<[^>]*>/g, '')}</p>
                              </div>
                              <div className="flex gap-1 ml-4">
