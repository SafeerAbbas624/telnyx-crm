              ...
              <div className="space-y-4 mt-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Enter your email template. Use {firstName}, {propertyAddress}, etc. for variables. HTML supported."
                    rows={8}
                    className="min-h-[200px]"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Use curly braces to add variables: {`{firstName}`}, {`{propertyAddress}`}, {`{cityState}`}, etc. HTML tags are supported.
                  </p>
                </div>
